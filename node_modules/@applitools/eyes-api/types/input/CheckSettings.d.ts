...
export declare class CheckSettingsAutomationFluent<TSpec extends SpecType = SpecType> extends CheckSettingsBaseFluent<RegionReference<TSpec>> {
    ...
    constructor(settings?: CheckSettingsAutomation<TSpec> | CheckSettingsAutomationFluent<TSpec>, spec?: CheckSettingsAutomationSpec<TSpec>);
    ...
    toJSON(): {
        target: undefined;
        settings: CoreCheckSettingsAutomation<TSpec>;
    };
}
...
export declare const Target: Target<SpecType> & {
